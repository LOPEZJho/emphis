...
class PageTest(LiveServerTestCase):
	...
	def test_browser_title(self):
		...
		inputAddress.click()
		inputAddress.send_keys('B5 L14 Bonifacio St., WIndsor Homes Subd., Brgy. Burol III, Dasmarinas City, Cavite')
		time.sleep(1)
		...
		inputValDate = self.browser.find_element_by_id('validDate')
		self.assertEqual(inputValDate.get_attribute('placeholder'), 'mm/dd/yyyy')
		inputValDate.click()
		inputValDate.send_keys('08/27/2020')
		time.sleep(1)
